...
function storeFormFields() {
  ...
  storeFormFieldValue('password-confirm');
...
function restoreFormFields() {
  ...
  restoreFormFieldValue('password-confirm');
...
function removeFromStorage() {
  ...
  localStorage.removeItem('password-confirm');
